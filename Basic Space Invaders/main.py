...
HEALTH_FONT = pygame.font.SysFont('ariel',25)
WINNER_FONT = pygame.font.SysFont('comicsans',100)
ENDING_FONT = pygame.font.SysFont('comicsans',50)
...
def draw_window(red,yellow,red_bullets,yellow_bullets,red_health,yellow_health):
    ...
    red_health_test = HEALTH_FONT.render(f"Health: {red_health}",1,WHITE)
    yellow_health_test = HEALTH_FONT.render(f"Health: {yellow_health}", 1, WHITE)
    WIN.blit(red_health_test,(WIDTH-red_health_test.get_width()-10,10))
    WIN.blit(yellow_health_test,(10,10))
...
def main():
    ...
    WIN.blit(SPACE,(0,0))
    end_text = ENDING_FONT.render("Play again? Press Y for yes or N for no", 1, WHITE)
    WIN.blit(end_text, ((WIDTH - end_text.get_width()) // 2, (HEIGHT - end_text.get_height()) // 2))
    pygame.display.update()
    pygame.time.delay(6000)
    goodbye_text = ENDING_FONT.render("Thanks for playing!", 1, WHITE)
        ...
        if __name__ == '__main__':
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_y:
                    ...
                    WIN.blit(SPACE,(0,0))
                    WIN.blit(goodbye_text, ((WIDTH - goodbye_text.get_width()) // 2, (HEIGHT - goodbye_text.get_height()) // 2))
                    pygame.display.update()
